...
const TRANSLATIONS = {
  cs: {
    ...
    bought: T.bought, until: T.until,
    priceLabel: T.priceLabel, serialLabel: T.serialLabel, buyDate: T.buyDate,
    warrantyUntil: T.warrantyUntil, warrantyLength: T.warrantyLength, remaining: T.remaining,
    noteLabel: T.noteLabel, changePhoto: T.changePhoto, addPhoto: T.addPhoto,
    logoutConfirm: T.logoutConfirm, count: T.count,
    emptyTitle: T.emptyTitle, emptyDesc: T.emptyDesc,
